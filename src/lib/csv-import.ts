...
const TYPE_ALIASES: Record<string, MeasurementType> = {
  ...
  walkingasymmetrypct: "walkingAsymmetry",
  doublesupport: "doubleSupport",
  doublesupportpct: "doubleSupport",
  headphoneaudioavg: "headphoneAudioAvg",
  headphoneaudio: "headphoneAudioAvg",
  headphoneaudiomax: "headphoneAudioMax",
