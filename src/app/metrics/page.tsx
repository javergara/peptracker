...
const TYPE_LABELS: Record<string, string> = {
  ...
  sleepAwake: "Awake in bed",
  sleepEfficiency: "Sleep efficiency",
  hrAvg: "Heart rate (avg)",
  hrMax: "Heart rate (max)",
  hrMin: "Heart rate (min)",
  walkingSpeed: "Walking speed",
  stepLength: "Step length",
  walkingAsymmetry: "Walking asymmetry",
  doubleSupport: "Double support",
  headphoneAudioAvg: "Headphone audio (avg)",
  headphoneAudioMax: "Headphone audio (max)",
  water: "Water",
...
const TYPE_DEFAULT_UNIT: Record<string, string> = {
  ...
  walkingAsymmetry: "%",
  doubleSupport: "%",
  headphoneAudioAvg: "dBA",
  headphoneAudioMax: "dBA",
  water: "mL",
  bpSystolic: "mmHg",
  bpDiastolic: "mmHg",
};
